...
import com.example.architechturestartercode.presentation.favmovies.view_model.FavViewModel
import com.example.architechturestartercode.presentation.favmovies.view_model.FavViewModelFactory
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Scaffold(
                ...
                topBar = {
                    TopAppBar(
                        title = { Text("❤️ My Favorites", fontWeight = FontWeight.Bold) },
                ...
                FavMoviesScreen(
                    ...
                    state = state,
                    onDelete = { viewModel.deleteFavMovie(it) }
                )
            }
        }
    }
